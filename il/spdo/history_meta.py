...
# Baseado em https://bitbucket.org/sqlalchemy/sqlalchemy/src/de4eb56fb6c8/examples/versioning/history_meta.py
# Mais informações em http://www.sqlalchemy.org/docs/orm/examples.html?highlight=version#versioned-objects
...
from il.spdo.config import DISABLE_VERSIONS
